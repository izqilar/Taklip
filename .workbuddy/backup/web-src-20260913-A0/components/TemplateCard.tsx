      ...
      {preview && (
        ...
        >
          ...
          >
            ...
            <div className="mx-auto w-40 overflow-hidden rounded-xl border border-gray-100 bg-gray-50 shadow-inner">
              <div className="relative flex aspect-[375/667] items-center justify-center">
                {template.cover ? (
                  <img src={template.cover} alt={template.name} className="h-full w-full object-cover" />
                ) : (
                  <SchemaThumbnail schema={template.schema} />
            ...
            <button
              ...
              className="mt-4 w-full rounded-lg bg-brand-500 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-brand-600"
            >
