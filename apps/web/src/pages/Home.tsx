...
export default function Home() {
  ...
  const HOT_TAGS = (t('home.hotTags', { returnObjects: true }) as unknown as string[]) ?? [];
  const slideTexts = (t('home.slides', { returnObjects: true }) as unknown as { eyebrow: string; title: string }[]) ?? [];
  const SLIDES = slideTexts.map((s, i) => ({ ...s, ...SLIDE_META[i] }));
  ...
  return (
    <div className="min-h-full bg-white text-gray-900">
      ...
      <div className="relative bg-[#D24830]">
        {/* 装饰背景 */}
